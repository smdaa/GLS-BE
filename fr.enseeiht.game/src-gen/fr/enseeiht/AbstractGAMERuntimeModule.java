...
import fr.enseeiht.generator.GAMEGenerator;
import fr.enseeiht.parser.antlr.GAMEAntlrTokenFileProvider;
import fr.enseeiht.parser.antlr.GAMEParser;
import fr.enseeiht.parser.antlr.internal.InternalGAMELexer;
import fr.enseeiht.scoping.GAMEScopeProvider;
import fr.enseeiht.serializer.GAMESemanticSequencer;
import fr.enseeiht.serializer.GAMESyntacticSequencer;
import fr.enseeiht.services.GAMEGrammarAccess;
import fr.enseeiht.validation.GAMEConfigurableIssueCodesProvider;
import fr.enseeiht.validation.GAMEValidator;
...
public abstract class AbstractGAMERuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "fr/enseeiht/GAME.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("fr.enseeiht.GAME");
	}
