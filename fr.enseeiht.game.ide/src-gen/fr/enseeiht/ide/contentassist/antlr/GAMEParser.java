...
public class GAMEParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GAMEGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConnaissanceAccess().getDescriptionsAssignment_3(), "rule__Connaissance__DescriptionsAssignment_3");
			builder.put(grammarAccess.getConnaissanceAccess().getVisibiliteAssignment_4(), "rule__Connaissance__VisibiliteAssignment_4");
			builder.put(grammarAccess.getConnaissanceAccess().getConditionsVisibiliteAssignment_5_1(), "rule__Connaissance__ConditionsVisibiliteAssignment_5_1");
